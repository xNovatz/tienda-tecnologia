...
$sql = "SELECT c.id_carrito, p.nombre, p.imagen, p.categoria,
...
<body>
    <div class="contenedor-pago">
        ...
        <div class="formulario-pago">
            ...
            <form id="formPago" onsubmit="event.preventDefault(); alert('✅ Pago procesado correctamente. Gracias por su compra.');">
